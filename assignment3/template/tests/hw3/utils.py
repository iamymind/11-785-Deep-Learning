...
def generate(model, sequence_length, batch_size, args, stochastic=False, inp=None, eval_batch_size=50):
    if inp is None:
    ...
    logits, hidden = model(inp, hidden, forward=sequence_length, stochastic=stochastic)
